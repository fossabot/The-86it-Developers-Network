...
$default = array(
			...
			'#FFFFFF',
			'#FFFFFF',
			'Go to the theme options to edit your footer message Line 1',
			'Go to the theme options to edit your footer message Line 2',
			'Go to the theme options to edit your footer message Line 3',
			'Go to the theme options to edit your footer message Line 4'
			);
