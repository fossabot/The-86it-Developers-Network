  ...
  <tr> 
    <td align="left" valign="bottom" nowrap="nowrap">
		<span class="nav"><a href="{U_POST_NEW_TOPIC}"><img src="{POST_IMG}" border="0" alt="{L_POST_NEW_TOPIC}" align="middle" /></a>
			...
			<!-- BEGIN thanks_button -->
			<a href="{thanks_button.U_THANK_TOPIC}">Thanks<img src="{thanks_button.THANK_IMG}" border="0" alt="{thanks_button.L_THANK_TOPIC}" align="middle" /></a>
			<!-- END thanks_button -->
		</span>
	</td>
...
<!-- BEGIN switch_spacer -->
    <tr> 
        <td class="spaceRow" colspan="2" height="1"><img src="themes/86it-Cortex/forums/images/spacer.gif" alt="" width="1" height="1" /></td>
    </tr>
<!-- END switch_spacer -->
<!-- BEGIN move_message -->
<tr>
