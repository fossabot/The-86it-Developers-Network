...
if ($_COOKIE["titanium_resolution_width"] == "1920") //235 is as small as you can go
{
   echo"<style type=\"text/css\">"
     ...
     . "-->"
     . "</style>"
     . "<table class=block cellSpacing=\"0\" cellPadding=\"0\" border=\"0\" width=\"259\">"
     . "<tr >"
	 ...
	 . "<div class=\"typeface-js\" style=\"font-family: Helvetiker\"><span class=\"style1\">$title</span></div></td>"
     . "<td>"
...
if ($_COOKIE["titanium_resolution_width"] == "1536") //235 is as small as you can go
{
   echo"<style type=\"text/css\">"
     . "<!--"
     . ".style1 {"
     ...
     . "<td background=\"".HTTPS."themes/$theme_name/tables/OpenTable/topmiddle.png\">"
     . "<img src=\"".HTTPS."themes/$theme_name/tables/OpenTable/leftcorner.png\" border=\"0\" width=\"39\" height=\"50\"></td>"
     . "<td width=\"0\" align=\"center\" background=\"".HTTPS."themes/$theme_name/tables/OpenTable/topmiddle.png\"><div class=\"typeface-js\" style=\"font-family: Helvetiker\"><span class=\"style1\">$title</span></div></td>"
     . "<td>"
     . "<img src=\"".HTTPS."themes/$theme_name/tables/OpenTable/rightcorner.png\" border=\"0\" width=\"39\" height=\"50\"></td>"
     . "</tr>"
     . "<tr>"
...
if ($_COOKIE["titanium_resolution_width"] == "1360")
{
   ...
   echo"<style type=\"text/css\">"
     ...
     . "-->"
     . "</style>"
     . "<table class=block cellSpacing=\"0\" cellPadding=\"0\" border=\"0\" width=\"219\">"
     . "<tr >"
     . "<td background=\"".HTTPS."themes/$theme_name/tables/OpenTable/topmiddle.png\">"
     . "<img src=\"".HTTPS."themes/$theme_name/tables/OpenTable/leftcorner.png\" border=\"0\" width=\"39\" height=\"50\"></td>"
     . "<td width=\"0\" align=\"center\" background=\"".HTTPS."themes/$theme_name/tables/OpenTable/topmiddle.png\"><div class=\"typeface-js\" style=\"font-family: Helvetiker\"><span class=\"style1\">$title</span></div></td>"
...
if ($_COOKIE["titanium_resolution_width"] == "1280")
{
   ...
   echo"<style type=\"text/css\">"
     ...
     . "-->"
     . "</style>"
     . "<table class=block cellSpacing=\"0\" cellPadding=\"0\" border=\"0\" width=\"235\">"
     . "<tr >"
     . "<td background=\"".HTTPS."themes/$theme_name/tables/OpenTable/topmiddle.png\">"
     . "<img src=\"".HTTPS."themes/$theme_name/tables/OpenTable/leftcorner.png\" border=\"0\" width=\"39\" height=\"50\"></td>"
     . "<td width=\"0\" align=\"center\" background=\"".HTTPS."themes/$theme_name/tables/OpenTable/topmiddle.png\"><div class=\"typeface-js\" style=\"font-family: Helvetiker\"><span class=\"style1\">$title</span></div></td>"
