...
<tr> 
  ...
  <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
    <tr> 
      ...
      <th width="45" class="thTop" nowrap="nowrap">{L_USERNAME}</th>
    ...
    <tr> 
      ...
      <td width ="220" class="{memberrow.ROW_CLASS}" align="center"><span class="gen"><a href="{memberrow.U_VIEWPROFILE}" class="gen">{memberrow.USERNAME}</a></span></td>
      <td class="{memberrow.ROW_CLASS}" align="center" valign="middle">&nbsp;{memberrow.EMAIL_IMG}&nbsp;</td>
      <!-- FLAGHACK-start -->
      <td class="{memberrow.ROW_CLASS}" align="center" valign="middle">
        <table class="gen">
          <tr>
            <td align="center">{memberrow.FROM}{memberrow.FLAG}</td>
          </tr>
        </table>
      </td>
      <!-- FLAGHACK-end -->
      <td class="{memberrow.ROW_CLASS}" align="center" valign="middle"><span class="gensmall">{memberrow.AGE}</span></td>
      <td width="125" class="{memberrow.ROW_CLASS}" align="center" valign="middle"><span class="gensmall">{memberrow.JOINED}</span></td>
