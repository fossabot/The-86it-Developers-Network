...
############################################################################################
	...
	{                                                                                      #     Added by Ernest Buffington
       require_once(NUKE_THEMES_DIR.$ThemeSel.'/includes/javascript.php');                 ##### facebook Mod v1.0
    }                                                                                      #     Oct 10th 2012
############################################################################################	
...
############################################################################
	...
	if ($_COOKIE["titanium_resolution_width"] == '1421')
	{
	  echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" height=\"17\"><br>\n";  /* line up the page hits and start date */
	}
    else
	if ($_COOKIE["titanium_resolution_width"] == '1280') # done by Ernest Allen Buffington 10/03/2017 Tuesday @ 4:51pm #
	{
	  ...
	  echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" height=\"14\"><br>\n";  /* line up the page hits and start date */
	}
    else
	if ($_COOKIE["titanium_resolution_width"] == '1920')
	{
	   ...
	   echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" height=\"13\"><br>\n"; /* line up the page hits and start date */
	}
    else
	...
	{
	  echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" height=\"15\"><br>\n";  /* line up the page hits and start date */
	}
	else
	echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" height=\"17\"><br>\n";  /* line up the page hits and start date */
	...
	echo "<div class=\"gen\" align=\"center\">We have recieved <strong>".$totalbr."</strong> "._PAGESVIEWS." ".$startdate."</div>";

	if ($_COOKIE["titanium_resolution_width"] == '1421')
	{
	  echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" height=\"12\"><br>\n";
	}
    else
	if ($_COOKIE["titanium_resolution_width"] == '1280') # done by Ernest Allen Buffington 10/03/2017 Tuesday @ 4:51pm #
	{
	  ...
	  {
	    echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" width=\"1\"height=\10\"><br>\n"; #
	    echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" width=\"1\"height=\10\"><br>\n"; #
	    echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" width=\"1\"height=\10\"><br>\n"; ########### 1280 Hack!
	    echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" width=\"1\"height=\10\"><br>\n"; #
	    echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" width=\"1\"height=\10\"><br>\n"; #
	...
	if ($_COOKIE["titanium_resolution_width"] == '1360')
	{
	  echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" height=\"6\"><br>\n";
	}
	else
	echo "<img src=\"".HTTPS."themes/".$ThemeSel."/header/spacer.png\" height=\"6\"><br>\n";
	...
	if (isset($cookie[1]))
	{
	   ...
	   else
	   {
	     ...
	     echo "<fieldset align='center'><legend><font color=\"C00000\"><b>Hi $cookie[1], thank you for stopping by!</b></font></legend>";
	     echo "<div class=\"supersmall\" align=\"center\">The Website/Portal you are viewing is running<br /></div>";
	     echo "<div class=\"supersmall\" align=\"center\"><b>PHP-Nuke Titanium</b>, written by <b>Ernest Allen Buffington</b>.<br /></div>";
	     echo "<div class=\"supersmall\" align=\"center\">The most scalable, secure and automated <b>C</b><font color=\"C00000\">ontent</font> <b>M</b><font color=\"C00000\">anagement</font> <b>S</b><font color=\"C00000\">ystem</font><br /></div>";
	     echo "<div class=\"supersmall\" align=\"center\">ever written with <font color=\"C00000\">PHP</font>,<font color=\"C00000\">MySQL</font>,<font color=\"C00000\">Curl</font> and <font color=\"C00000\">Java</font>.<br /></div>";
	     echo "</fieldset>";
	     echo "</td></table>";
	   }
	}
