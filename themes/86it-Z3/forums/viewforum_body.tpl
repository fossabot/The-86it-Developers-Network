...
<table width="100%" cellpadding="2" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
	...
	<td class="row1" width="100%" height="50" onmouseover="this.style.backgroundImage='url(../themes/86it-Z3/images/backgrounds/block.png)'" onmouseout="this.style.backgroundImage='url(../themes/86it-Z3/images/backgrounds/b.png)'"><span class="forumlink"> <a href="{catrow.forumrow.U_VIEWFORUM}" class="forumlink<!-- IF catrow.forumrow.UNREAD --> topic-new<!-- ENDIF -->">{catrow.forumrow.FORUM_NAME}</a><br />
...
<td class="row1" width="100%"  onmouseover="this.style.backgroundImage='url(../themes/86it-Z3/images/backgrounds/block.png)'" onmouseout="this.style.backgroundImage='url(../themes/86it-Z3/images/backgrounds/b.png)'" onclick="window.location.href='{topicrow.U_VIEW_TOPIC}'"><span class="topictitle">{topicrow.NEWEST_POST_IMG}{topicrow.TOPIC_ATTACHMENT_IMG}{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a></span><span class="gensmall"><br />
...
<table width="100%" cellspacing="0" border="0" align="center" cellpadding="0">
    <tr>
		...
		<table cellspacing="3" cellpadding="0" border="0" width="874" height="100%">
            <tr>
        <td width="29" align="left"><img src="{FOLDER_NEW_IMG}" alt="{L_NEW_POSTS}" /></td>
          <td class="gensmall" width="145">New Posts</td>
          <td width="12">&nbsp;&nbsp;</td>
          <td width="30" align="center"><img src="{FOLDER_IMG}" alt="{L_NO_NEW_POSTS}" /></td>
          <td class="gensmall" width="183">No New Posts</td>
          <td width="12">&nbsp;&nbsp;</td>
          <!-- Start replacement - Global announcement MOD -->
          <td width="30" align="center"><img src="{FOLDER_GLOBAL_ANNOUNCE_IMG}" alt="{L_GLOBAL_ANNOUNCEMENT}" /></td>
          <td class="gensmall" width="175">Old Global Announcement</td>
          <!-- End replacement - Global announcement MOD -->
          <td class="gensmall" width="16"><img src="{FOLDER_GLOBAL_ANNOUNCE_NEW_IMG}" alt="{L_STICKY}" /></td>
          <td class="gensmall" width="187">New Global Announcement</td>
          <td class="gensmall" width="13">&nbsp;</td>
        </tr>
        <tr>
          <td width="29" align="center"><img src="{FOLDER_HOT_NEW_IMG}" alt="{L_NEW_POSTS_HOT}" /></td>
          <td class="gensmall" width="145">New Posts [Popular]</td>
          <td width="12">&nbsp;&nbsp;</td>
          <td width="30" align="center"><img src="{FOLDER_HOT_IMG}" alt="{L_NO_NEW_POSTS_HOT}" /></td>
          <td class="gensmall" width="183">No New Posts [Popular]</td>
          <td width="12">&nbsp;&nbsp;</td>
          <!-- Start replacement - Global announcement MOD -->
          <td width="30" align="center"><img src="{FOLDER_ANNOUNCE_IMG}" alt="{L_ANNOUNCEMENT}" /></td>
          <td class="gensmall" width="175">Old Regular Announcement</td>
          <!-- End replacement - Global announcement MOD -->
          <td class="gensmall" width="16"><img src="{FOLDER_ANNOUNCE_NEW_IMG}" alt="{L_STICKY}" /></td>
          <td class="gensmall" width="187">New Regular Announcements</td>
          <td class="gensmall" width="13">&nbsp;</td>
        </tr>
        <tr>
          <td width="29" align="center"><img src="{FOLDER_LOCKED_NEW_IMG}" alt="{L_NEW_POSTS_LOCKED}" /></td>
          <td class="gensmall" width="145">New Posts [Locked]
          <td width="12">&nbsp;&nbsp;</td>
          <td width="30" align="center"><img src="{FOLDER_LOCKED_IMG}" alt="{L_NO_NEW_POSTS_LOCKED}" /></td>
          <td class="gensmall" width="183">No New Posts [Lockaed]</td>
          <!-- Start add - Global announcement MOD -->
          <td width="12">&nbsp;&nbsp;</td>
          <td width="30" align="center"><img src="{FOLDER_STICKY_IMG}" alt="{L_STICKY}" /></td>
          <td class="gensmall" width="175">{L_STICKY}</td>
