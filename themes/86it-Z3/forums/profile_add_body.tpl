...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr>
	  ...
	  <td class="row2">
		<input type="text" class="post"style="width: 300px"  name="myspace" size="25" maxlength="255" value="{MYSPACE}" /> <br /><font color="#CC0000">i.e. http://www.myspace.com/jimmi.fartface.hoffa</font>
	  </td>
	</tr>  
	<tr>
	  <td class="row1"><span class="gen"><b>Enter Your Facebook Address:</b> </span></td>
	  <td class="row2">
		<input type="text" class="post"style="width: 300px"  name="userfacebook" size="25" maxlength="255" value="{FACEBOOK}" />  <br /><font color="#CC0000">i.e. http://www.facebook.com/jimmi.fartface.hoffa</font>
	  </td>
	</tr>      
<!-- BEGIN xdata -->
<!-- BEGIN switch_is_icq -->
...
<!-- END xdata -->
    ...
    <tr>
        <td class="row1" colspan="2"><table width="70%" cellspacing="2" cellpadding="0" border="0" align="center">
            <tr>
                <td width="65%" valign="top"><span class="gensmall"><font color="#CC0000">{L_AVATAR_EXPLAIN}</font></span></td>
                <td align="center"><span class="gensmall"><b>{L_CURRENT_IMAGE}</b></span><br />{AVATAR}<br /><input type="checkbox" name="avatardel" />&nbsp;<span class="gensmall"><font color="#CC0000">{L_DELETE_AVATAR}</font></span></td>
            </tr>
        </table></td>
    </tr>
    <!-- BEGIN switch_avatar_local_upload -->
    <tr>
        <td class="row1"><span class="gen"><b>{L_UPLOAD_AVATAR_FILE}:</b></span></td>
    ...
    <tr>
        <td class="row1"><span class="gen"><b>{L_UPLOAD_AVATAR_URL}:</b></span><br /><span class="gensmall"><font color="#CC0000">{L_UPLOAD_AVATAR_URL_EXPLAIN}</font></span></td>
        <td class="row2"><input type="text" name="avatarurl" size="40" class="post" style="width:200px" /></td>
    </tr>
    <!-- END switch_avatar_remote_upload -->
    <!-- BEGIN switch_avatar_remote_link -->
    <tr>
        <td class="row1"><span class="gen"><b>{L_LINK_REMOTE_AVATAR}:</b></span><br /><span class="gensmall"><font color="#CC0000">{L_LINK_REMOTE_AVATAR_EXPLAIN}</font></span></td>
        <td class="row2"><input type="text" name="avatarremoteurl" size="40" class="post" style="width:200px" /></td>
    </tr>
    <!-- END switch_avatar_remote_link -->
    <!-- BEGIN switch_avatar_local_gallery -->
    <tr>
        <td class="row1"><span class="gen"><b>{L_AVATAR_GALLERY}:</b></span></td>
