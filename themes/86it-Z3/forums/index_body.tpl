...
<td class="row1" width="100%" height="50" onmouseover="this.style.backgroundImage='url(../themes/86it-Z3/images/backgrounds/block.png)'" onmouseout="this.style.backgroundImage='url(../themes/86it-Z3/images/backgrounds/b.png)'"  onclick="window.location.href='{catrow.forumrow.U_VIEWFORUM}'"><span {catrow.forumrow.forum_color} class="forumlink"> <a href="{catrow.forumrow.U_VIEWFORUM}" {catrow.forumrow.forum_color} class="forumlink">{catrow.forumrow.FORUM_NAME}</a><br />
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
  ...
  <tr> 
    <td class="row1" align="center" valign="middle" rowspan="3"><img src="themes/86it-Z3/forums/images/whosonline.png" width="95" alt="{L_WHO_IS_ONLINE}" /></td>
  ...
  <tr> 
	<td class="row1" colspan="2"><table cellpadding="0" cellspacing="0" border="0">
		<tr>
			<td align="center" valign="middle" style="padding-right: 3px"><img src="themes/86it-Z3/forums/images/cake.gif" alt="{L_VIEW_BIRTHDAYS}" /></td>
...
<table cellspacing="3" border="0" align="center" cellpadding="0">
  <tr> 
    <td width="20" align="center"><img src="themes/86it-Z3/forums/images/lang_{LANG}/folder_new.png" alt="{L_NEW_POSTS}"/></td>
    <td><span class="gensmall">{L_NEW_POSTS}</span></td>
    <td>&nbsp;&nbsp;</td>
    <td width="20" align="center"><img src="themes/86it-Z3/forums/images/lang_{LANG}/folder.png" alt="{L_NO_NEW_POSTS}" /></td>
    <td><span class="gensmall">{L_NO_NEW_POSTS}</span></td>
    <td>&nbsp;&nbsp;</td>
    <td width="20" align="center"><img src="themes/86it-Z3/forums/images/lang_{LANG}/folder_lock.png" alt="{L_FORUM_LOCKED}" /></td>
