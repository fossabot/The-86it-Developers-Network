...
<table width="{GLANCE_TABLE_WIDTH}" cellpadding="2" cellspacing="1" border="0" class="forumline" align="center">
    ...
    <tr>
        ...
        <td valign="middle" width="100%" class="row1" onmouseover="this.style.backgroundImage='url(../themes/86it-Z3/images/backgrounds/block.png)'" onmouseout="this.style.backgroundImage='url(../themes/86it-Z3/images/backgrounds/b.png)'"><span class="genmed"><a href="{news.TOPIC_LINK}" class="genmed">{news.TOPIC_TITLE}</a></span></td>
    ...
    <tr>
        ...
        <td valign="middle" width="100%" class="row1" onmouseover="this.style.backgroundImage='url(../themes/86it-Z3/images/backgrounds/block.png)'" onmouseout="this.style.backgroundImage='url(../themes/86it-Z3/images/backgrounds/b.png)'"><span class="genmed"><a href="{recent.TOPIC_LINK}" class="genmed">{recent.TOPIC_TITLE}</a></span></td>
